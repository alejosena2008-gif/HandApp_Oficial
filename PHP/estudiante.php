...
<title>HandApp · Panel del Estudiante</title>
<meta name="description" content="Panel de estudiante de HandApp: sigue tu progreso, continúa tus lecciones de lengua de señas, juega y desbloquea logros." />
...
.logo-text { font-family: var(--font-display); font-size: var(--font-size-xl); font-weight: 800; letter-spacing: -0.02em; }
...
.avatar-name { font-size: var(--font-size-sm); font-weight: 600; }
...
.panel-link { font-size: var(--font-size-sm); font-weight: 600; color: var(--cyan); text-decoration: none; display: inline-flex; align-items: center; gap: var(--spacing-1); transition: gap var(--transition-fast); }
...
.continue-eyebrow { font-size: var(--font-size-xs); font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; color: var(--cyan); }
    ...
    <aside class="sidebar glass" id="sidebar" aria-label="Navegación principal">
        ...
        <div class="sidebar-footer">
            <div class="streak-card">
                ...
                <div>
                    <div class="streak-num">12 días</div>
                    <div class="streak-text">¡Racha activa! Sigue así.</div>
                </div>
            </div>
        </div>
    </aside>
    ...
    <div class="main">
        <header class="topbar">
            ...
            <div class="search-box">
                ...
                <input type="search" id="searchInput" placeholder="Buscar lecciones o juegos..." aria-label="Buscar" />
            </div>
                ...
                <div class="notif-wrap">
                    ...
                    <div class="notif-panel glass" id="notifPanel" role="menu">
                        ...
                        <div class="notif-item">
                            ...
                            <div><p class="notif-text"><strong>¡Nuevo logro!</strong> Desbloqueaste "Maestro del abecedario".</p><span class="notif-time">Hace 2 horas</span></div>
                        </div>
                        <div class="notif-item">
                            <span class="notif-dot cyan" aria-hidden="true"></span>
                            <div><p class="notif-text">Tu amiga <strong>Camila</strong> superó tu puntaje semanal.</p><span class="notif-time">Hace 5 horas</span></div>
                        </div>
                        <div class="notif-item">
                            <span class="notif-dot amber" aria-hidden="true"></span>
                            <div><p class="notif-text">Te faltan <strong>2 lecciones</strong> para subir al nivel 8.</p><span class="notif-time">Ayer</span></div>
                        </div>
                    </div>
                </div>
                <button class="avatar" aria-label="Perfil de Valentina">
                    <span class="avatar-img">VR</span>
                    <span class="avatar-name">Valentina R.</span>
                </button>
            </div>
        </header>
        ...
        <main class="content">
            ...
            <section class="welcome" data-reveal>
                <div>
                    <h1 class="welcome-title"><span id="greetWord">Hola</span>, Valentina <span aria-hidden="true">👋</span></h1>
                    <p class="welcome-subtitle">Llevas <strong>12 días</strong> seguidos aprendiendo · <span id="todayDate"></span></p>
                </div>
            ...
            <!-- Stats -->
            <section class="stats-grid" aria-label="Resumen de progreso">
                <div class="stat-card glass spot" data-reveal data-tilt>
                    <div class="ring-icon">
                        <svg class="ring-svg" viewBox="0 0 72 72" aria-hidden="true">
                            ...
                            <circle class="ring-fill" cx="36" cy="36" r="30" stroke="url(#grad-indigo)" data-ring="70"></circle>
                        </svg>
                        <span class="stat-icon indigo" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></span>
                    </div>
                    <div class="stat-value" data-count="14">0</div>
                    <div class="stat-name">Lecciones completadas</div>
                    <span class="stat-trend"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>+3 esta semana</span>
                </div>
                <div class="stat-card glass spot" data-reveal data-tilt>
                    <div class="ring-icon">
                        <svg class="ring-svg" viewBox="0 0 72 72" aria-hidden="true">
                            <circle class="ring-track" cx="36" cy="36" r="30"></circle>
                            <circle class="ring-fill" cx="36" cy="36" r="30" stroke="url(#grad-teal)" data-ring="83"></circle>
                        </svg>
                        <span class="stat-icon teal" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 11V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v0"/><path d="M14 10V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v2"/><path d="M10 10.5V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8"/><path d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15"/></svg></span>
                    </div>
                    <div class="stat-value" data-count="248">0</div>
                    <div class="stat-name">Señas aprendidas</div>
                    <span class="stat-trend"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>+22 esta semana</span>
                </div>
                <div class="stat-card glass spot" data-reveal data-tilt>
                    <div class="ring-icon">
                        <svg class="ring-svg" viewBox="0 0 72 72" aria-hidden="true">
                            <circle class="ring-track" cx="36" cy="36" r="30"></circle>
                            <circle class="ring-fill" cx="36" cy="36" r="30" stroke="url(#grad-amber)" data-ring="93"></circle>
                        </svg>
                        <span class="stat-icon amber" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg></span>
                    </div>
                    <div class="stat-value" data-count="1860" data-suffix=" XP">0</div>
                    <div class="stat-name">Puntos de experiencia</div>
                    <span class="stat-trend"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>Nivel 7</span>
                </div>
                <div class="stat-card glass spot" data-reveal data-tilt>
                    <div class="ring-icon">
                        <svg class="ring-svg" viewBox="0 0 72 72" aria-hidden="true">
                            <circle class="ring-track" cx="36" cy="36" r="30"></circle>
                            <circle class="ring-fill" cx="36" cy="36" r="30" stroke="url(#grad-rose)" data-ring="57"></circle>
                        </svg>
                        <span class="stat-icon rose" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"/></svg></span>
                    </div>
                    <div class="stat-value" data-count="12" data-suffix=" días">0</div>
                    <div class="stat-name">Racha actual</div>
                    <span class="stat-trend"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>Récord: 21</span>
                </div>
            </section>
            ...
            <div class="grid-2">
                ...
                <div>
                    ...
                    <article class="continue-card glass spot" data-reveal>
                        ...
                        <div class="continue-body">
                            <p class="continue-eyebrow">Continúa donde lo dejaste</p>
                            <h2 class="continue-title">Lección 5: El abecedario dactilológico</h2>
                            <p class="continue-meta">Módulo 2 · 8 de 12 señas dominadas</p>
                            <div class="progress-track"><span class="progress-fill" style="width:67%"></span></div>
                            <div class="continue-progress-label"><span>Progreso de la lección</span><span>67%</span></div>
                        </div>
                    </article>
                    ...
                    <section class="panel-card glass" data-reveal>
                        <div class="panel-head">
                            <h2 class="panel-title">Tu ruta de aprendizaje</h2>
                        ...
                        <div class="lesson-list" id="lessonList">
                            <div class="lesson-item done">
                                ...
                                <div class="lesson-info">
                                    <span class="lesson-num">Lección 04</span>
                                    <div class="lesson-name">Saludos y presentaciones</div>
                                    <div class="lesson-desc">Completada · 10 señas</div>
                                </div>
                                <div class="lesson-side">
                                    <div class="lesson-mini-track"><span class="lesson-mini-fill" style="width:100%"></span></div>
                                    <span class="lesson-pct">100%</span>
                                </div>
                            </div>
                            <div class="lesson-item">
                                <span class="lesson-thumb current" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></span>
                                <div class="lesson-info">
                                    <span class="lesson-num">Lección 05</span>
                                    <div class="lesson-name">El abecedario dactilológico</div>
                                    <div class="lesson-desc">En progreso · 8 de 12 señas</div>
                                </div>
                                <div class="lesson-side">
                                    <div class="lesson-mini-track"><span class="lesson-mini-fill" style="width:67%"></span></div>
                                    <span class="lesson-pct">67%</span>
                                </div>
                            </div>
                            <div class="lesson-item">
                                <span class="lesson-thumb" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></span>
                                <div class="lesson-info">
                                    <span class="lesson-num">Lección 06</span>
                                    <div class="lesson-name">Los números del 1 al 100</div>
                                    <div class="lesson-desc">Disponible · 15 señas</div>
                                </div>
                                <div class="lesson-side">
                                    <div class="lesson-mini-track"><span class="lesson-mini-fill" style="width:0%"></span></div>
                                    <span class="lesson-pct">0%</span>
                                </div>
                            </div>
                            <div class="lesson-item locked">
                                <span class="lesson-thumb" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></span>
                                <div class="lesson-info">
                                    <span class="lesson-num">Lección 07</span>
                                    <div class="lesson-name">La familia y las relaciones</div>
                                    <div class="lesson-desc">Completa la lección 6 para desbloquear</div>
                                </div>
                                <div class="lesson-side">
                                    <span class="lock-ic" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></span>
                                </div>
                            </div>
                        </div>
                        <p class="no-results" id="lessonNoResults">No encontramos lecciones que coincidan con tu búsqueda.</p>
                    </section>
                </div>
                ...
                <div>
                    ...
                    <section class="panel-card glass" data-reveal style="margin-bottom: var(--spacing-6);">
                        <div class="panel-head"><h2 class="panel-title">Objetivos de hoy</h2></div>
                        <div class="goal-list" id="goalList">
                            <div class="goal-item completed" data-xp="60">
                                ...
                                <span class="goal-text">Practicar 10 señas nuevas</span>
                                <span class="goal-xp">+60 XP</span>
                            </div>
                            <div class="goal-item completed" data-xp="60">
                                <span class="goal-check" role="checkbox" aria-checked="true" tabindex="0"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>
                                <span class="goal-text">Completar 1 lección</span>
                                <span class="goal-xp">+60 XP</span>
                            </div>
                            <div class="goal-item" data-xp="40">
                                ...
                                <span class="goal-text">Jugar 1 partida de práctica</span>
                                <span class="goal-xp">+40 XP</span>
                            </div>
                            <div class="goal-item" data-xp="40">
                                <span class="goal-check" role="checkbox" aria-checked="false" tabindex="0"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>
                                <span class="goal-text">Repasar señas del día anterior</span>
                                <span class="goal-xp">+40 XP</span>
                            </div>
                        </div>
                        <div class="daily-progress">
                            <div class="daily-row">
                                ...
                                <span class="daily-num" id="dailyNum">120 / 200 XP</span>
                            </div>
                            <div class="daily-track"><span class="daily-fill" id="dailyFill" style="width:60%"></span></div>
                        </div>
                    </section>
                    ...
                    <section class="panel-card glass" data-reveal>
                        ...
                        <div class="achv-grid">
                            <div class="achv">
                                <span class="achv-medal medal-amber" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"/></svg></span>
                                <span class="achv-name">Racha de 10 días</span>
                            </div>
                            <div class="achv">
                                ...
                                <span class="achv-name">Primeras 100 señas</span>
                            </div>
                            <div class="achv">
                                ...
                                <span class="achv-name">Maestro del abecedario</span>
                            </div>
                            <div class="achv locked">
                                ...
                                <span class="achv-name">Conversador experto</span>
                            </div>
                        </div>
                    </section>
                </div>
            ...
            <section class="section-block" data-reveal>
                <div class="panel-head">
                    <h2 class="panel-title">Juegos para practicar</h2>
                    <a href="#" class="panel-link">Ver todos <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg></a>
                </div>
                <div class="games-grid" id="gamesGrid">
                    <a href="#" class="game-card glass spot" data-tilt>
                        <span class="game-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="11" x2="10" y2="11"/><line x1="8" y1="9" x2="8" y2="13"/><line x1="15" y1="12" x2="15.01" y2="12"/><line x1="18" y1="10" x2="18.01" y2="10"/><path d="M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.414-1.414A2 2 0 0 1 9.828 16h4.344a2 2 0 0 1 1.414.586L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.545-.604-6.584-.685-7.258-.007-.05-.011-.1-.017-.151A4 4 0 0 0 17.32 5z"/></svg></span>
                        <div>
                            <div class="game-title">Adivina la seña</div>
                            <div class="game-desc">Identifica la seña correcta contra reloj</div>
                        </div>
                    </a>
                    <a href="#" class="game-card glass spot" data-tilt>
                        <span class="game-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg></span>
                        <div>
                            <div class="game-title">Memoria de señas</div>
                            <div class="game-desc">Empareja cada seña con su significado</div>
                        </div>
                    </a>
                    <a href="#" class="game-card glass spot" data-tilt>
                        <span class="game-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="15" x2="15" y2="15"/></svg></span>
                        <div>
                            <div class="game-title">Deletreo veloz</div>
                            <div class="game-desc">Deletrea palabras con el abecedario</div>
                        </div>
                    </a>
                </div>
                <p class="no-results" id="gamesNoResults">No encontramos juegos que coincidan con tu búsqueda.</p>
            </section>
        </main>
    </div>
</div>
...
(function () {
    ...
    var lessonItems = document.querySelectorAll("#lessonList .lesson-item");
    var gameCards = document.querySelectorAll("#gamesGrid .game-card");
    var lessonNoResults = document.getElementById("lessonNoResults");
    var gamesNoResults = document.getElementById("gamesNoResults");
    ...
    searchInput.addEventListener("input", function () {
        ...
        lessonItems.forEach(function (item) {
            ...
            if (match) lessonMatches++;
        });
        lessonNoResults.classList.toggle("show", q.length > 0 && lessonMatches === 0);
        ...
        gameCards.forEach(function (card) {
            ...
            if (match) gameMatches++;
        });
        gamesNoResults.classList.toggle("show", q.length > 0 && gameMatches === 0);
    });
    ...
    /* ---- Texto flotante de XP ---- */
    function spawnFloatingXP(el, xp) {
        var r = el.getBoundingClientRect();
    ...
    /* ---- Objetivos diarios: marcar/desmarcar con XP dinámico ---- */
    var TOTAL_GOALS_XP = 200;
    var dailyFill = document.getElementById("dailyFill");
    var dailyNum = document.getElementById("dailyNum");
 
    function updateDailyXP() {
        var earned = 0;
        document.querySelectorAll(".goal-item").forEach(function (g) {
            if (g.classList.contains("completed")) earned += parseInt(g.getAttribute("data-xp"), 10) || 0;
        });
        var pct = Math.min(100, (earned / TOTAL_GOALS_XP) * 100);
        dailyFill.style.width = pct + "%";
        dailyNum.textContent = earned + " / " + TOTAL_GOALS_XP + " XP";
        return earned;
    }
    ...
    goals.forEach(function (goal) {
        ...
        function toggle() {
            ...
            if (done && !wasCompleted) {
                spawnFloatingXP(check, goal.getAttribute("data-xp"));
                showToast("¡Bien hecho! Objetivo completado.", "check");
            }
            var earned = updateDailyXP();
            if (earned >= TOTAL_GOALS_XP) {
                burstConfetti();
                showToast("¡Meta diaria completada! Sigue así.", "star");
            }
        }
